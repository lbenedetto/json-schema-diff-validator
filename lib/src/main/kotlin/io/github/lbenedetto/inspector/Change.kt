...
data class FieldFormatChange(
  override val path: String,
  override val changeType: ChangeType,
  val oldFormat: String?,
  val newFormat: String?
) : ChangeWithType {
  override fun toString() = withContext("Field format changed from $oldFormat to $newFormat")
}

data class NonNullRequirementChange(
  override val path: String,
  override val field: String,
  override val changeType: ChangeType
) : ChangeWithField {
...
data class NotAbsentRequirementChange(
  override val path: String,
  override val field: String,
  override val changeType: ChangeType
) : ChangeWithField {
